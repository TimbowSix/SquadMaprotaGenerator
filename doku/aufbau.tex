\section{Aufbau}
    ...
    \label{sub:AufbauImDetail-Map}
        ...
        \subsubsection{Mapvoteweight}
            ...
            Es ist allerdings nicht die Mapwahrscheinlichkeit gemessen an den Votes sondern ein rein internes Weight. \todo{satz macht keine sinn oder ?}
        ...
        \subsubsection{Berechnung der Mapwahrscheinlichkeit}
            ...
            \begin{itemize}
                ...
                \end{equation}
                nun das neue Mapvoteweight \todo{ das Mapvoteweight wurde vorher als was anders beschrieben} ist. $a$ und $b$ sind zwei freie Parameter welche die Steigung und den Offset beeinflussen. 
        ...
        \subsubsection{Memory Kernel}
            ...
            Dies wird dadurch implementiert, dass das Mapweight \todo{meinst du hier vielleicht das Distanzweight ?} effektiv $0$ ist für diese Map solange diese noch im Gedächtnis bleibt.
    ...
    Diese hängen nur von den Mapvotes \todo{seit wann hängen Layervotes von mapvotes ab ?} ab, welche mit der vorher genannten Sigmoidfunktion moduliert werden.
