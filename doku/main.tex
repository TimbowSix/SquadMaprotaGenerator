...
\title{Squad Maprotagenerator 3.0}
...
\usepackage[
	pdftitle={Squad Maprotagenerator 3.0},
	pdfsubject={},
...
\begin{document}
    ...
    \end{boxedlaw}
    \begin{center}
      \includegraphics[width=0.7\textwidth]{holy_colonel.png}
    \end{center}
    ...
    \include{Optimizer.tex}

    \include{Ergebnisse.tex}

    \include{Ausblick.tex}
