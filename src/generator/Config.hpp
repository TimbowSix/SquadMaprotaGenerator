...
class Config{
    private:
        ...
        */
        ...
        /**
         * @brief whether layers should be updated from the API or use locally stored
        */
        bool update_layers;
        /**
        ...
        */
         ...
         *        layers within this distance are being locked for {biom_spacing} turns
        */
        ...
        */
        ...
        /**
         * @brief whether the optimizer should run automatically if relevant setting have changed
        */
        bool auto_optimize;
        ...
        */
        ...
        /**
         * @brief whether the same main mode is allowed to come directly after another
        */
        bool space_main;
        /**
